        ...
        item.replaceWith """
          <div class='ptz-editor--editor mt15 mb15 p10'>
            <div class='ptz-editor--tools pb5'>
              <span class='ptz--btn ptz--size-11 mr5' role='h2'>h2</span>
              <span class='ptz--btn ptz--size-11 mr5' role='h3'>h3</span>
              <span class='ptz--btn ptz--size-11 mr30' role='h4'>h4</span>

              <span class='ptz--btn ptz--size-11 mr5 b' role='b'>B</span>
              <span class='ptz--btn ptz--size-11 mr5 i' role='i'>I</span>
              <span class='ptz--btn ptz--size-11 mr5 u' role='u'>U</span>
              <span class='ptz--btn ptz--size-11 mr5 u' role='hl'>HL</span>
              <span class='ptz--btn ptz--size-11 mr30'   role='del'>DEL</span>

              <span class='ptz--btn ptz--size-11 mr5'      role='link'>LINK</span>
              <span class='ptz--btn ptz--size-11 mr5 mr30' role='img'>IMG</span>

              <span class='ptz--btn ptz--size-11 mr5' role='code'>CODE</span>
              <span class='ptz--btn ptz--size-11 mr5' role='yt'>YT</span>
              <span class='ptz--btn ptz--size-11 mr5 mr30' role='ig'>IG</span>

              <span class='ptz--btn ptz--size-11 mr5'      role='ol'>OL</span>
              <span class='ptz--btn ptz--size-11 mr5' role='ul'>UL</span>
            </div>
